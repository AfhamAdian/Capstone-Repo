...
-- Kept as-is (likely regenerated by a Supabase schema dump) - see backend/db/
-- for this same schema split into per-domain files, plus the survey feature's
-- migrations and a runnable consolidated migration script.
